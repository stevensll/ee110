...
; This file demonstrates the servo for HW5 by
;
; Revision History:
;    12/12/25  Steven Lei       initial revision
...
Main:
        ...
        BL      InitGPT1                ;initialize timer 1 - for servo
        BL      InitServo               ;iniitalize servo (variables, I/O)
